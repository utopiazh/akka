 ...
 * s/KeyValueBehavior/KeyValueBehaviorWithEnforcedReplies/
 */

/**
 * FunctionalInterface for reacting on commands
 *
 * Used with [[CommandHandlerWithReplyBuilder]] to setup the behavior of a [[KeyValueBehaviorWithEnforcedReplies]]
 */
@FunctionalInterface
